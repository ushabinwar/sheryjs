...
elems.forEach(function(elem){
  ...
  if(!animating){
    ...
    gsap.to(h1s[index],{
        ...
        duration:1,
        onComplete: function(){
            gsap.set(this._targets[0],{top:"100%"})//this._targets[0] This is element upper wala
            animating=false
        }
       })
